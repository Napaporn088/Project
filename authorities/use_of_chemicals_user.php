...
<html>
<head>
  <title>สรุปการใช้สารเคมีโดยกำหนดวันที่</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
          ...
          <h2 class="page-header">สรุปการใช้สารเคมีโดยกำหนดวันที่</h2><br><br>

          <center>
             <form class="form-horizontal ">  
              <strong> จากวันที่: </strong> <input type="text" name="search" placeholder=" search" >&emsp;&emsp;
              <strong> ถึงวันที่: </strong> <input type="text" name="search1" placeholder=" search" >  <br><br>
          ...
          <button type="button" class="btn btn-default btn-sm ">
            ...
            <table class="table_check" style="width: 80%">
                <tr>
                  ...
                  <th style="width: 20%"><center>รายการ</center></th>
