...
<html lang="en">
  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="show_equipment_teacher.php">รายชื่อสารเคมี</a></li>

        <li><a href="show_chemical_tescher.php">รายชื่อวัสดุและเครื่องแก้ว</a></li>

         <li class="dropdown"><a data-toggle="dropdown">ตรวจสอบคำร้อง <span class="caret"></span> </a>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <div > 
           <center> <h4>แบบฟอร์มเบิก / ยืม สารเคมี วัสดุ เครื่องแก้ว</h4></center></div><br>
            ...
            <form action="confirm_teacher.php" name="data" method="POST" >
 ...
 <form action="confirm_teacher.php" name="frm" method="POST" >  
  <?php 
      for ($i=0; $i <10 ; $i++) {   
    echo "<tr>";
       ...
       echo $i+1;
       echo "</td>";
       echo "<td><input style='border: none'  type='text' name='list[]' size='35' value=''></td>";
       echo "<td><input style='border: none'  type='text' name='chem[]' size='3' value=''></td>";
       echo "<td><input style='border: none'  type='text' name='bran[]' size='3' value=''></td>";
       echo "<td><input style='border: none'  type='text' name='grande[]' size='2' value=''></td>";
       echo "<td><input style='border: none'  type='text' name='size[]' size='2' value=''></td>";
       echo "<td><input style='border: none'  type='text' name='price[]' size='2' value=''></td>";
    ...
    <strong> วันที่ยืม : </strong><input type="text" name="datepicker" id="datepicker" ></div> <br><br>
