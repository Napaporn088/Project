      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <div > 
           <center> <h4>แบบฟอร์มเบิก / ยืม สารเคมี วัสดุ เครื่องแก้ว</h4></center></div><br>
            ...
            ?>
            <div><center> ห้องปฎิบัติการ <?php echo $_POST['room']; ?> คณะวิทยาศาสตร์การแพทย์ </center></div><br><br>
           ...
           <center>
            ...
            ?> 
              ...
              ?>
                &emsp;&emsp;  <b>มีความประสงค์ขอเบิก/ยืม รายการวัสดุ สารเคมีต่อไปนี้จากห้องปฎิบัติการ เพื่อใช้ในงาน : </b><?php echo $_SESSION['pro']; ?> <?php echo $_SESSION['txt']; ?>

              
           </center></div><br>

           <center> 
      <form action="../user/insert_chemical_submit.php" name="frm" method="POST" >  
    ...
    ?>
      ...
      $_SESSION['date_re'] =  date( "d-m-Y", strtotime("+7 day", strtotime($_SESSION['datedb'])));
       ?>
        ...
        <strong> วันที่คืน : </strong> <?php echo $_SESSION['date_re']; ?> <br><br>
